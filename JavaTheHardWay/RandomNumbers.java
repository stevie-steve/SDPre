...
// pick three random intigers from 1 to 3 and print them
    a = 1 + (int)(3*Math.random() );
    b = 1 + (int)(3*Math.random() );
    c = 1 + (int)(3*Math.random() );

    System.out.println("these are three different number: " +  a + " , " + b + " , " + c );

// pick three random intigers between 5 and 10
    a = 5 + (int)(6*Math.random() );
    b = 5 + (int)(6*Math.random() );
    c = 5 + (int)(6*Math.random() );

    System.out.println("these are three different number between 5 and 10: " +  a + " , " + b + " , " + c );
  }
}
